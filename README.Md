...
Now with the design pattern explained, i want to go over how it will now correlate with our Folder Structure. This structure can be broken down into 4 parts: 
  ...
  *Referencing other Components*
   * To continue following a MVVM pattern, any reference of one particular page/feature component in another must be done via the __Screens__ directory. This sort of referencing is dealing with how the user *views* the screen, which means this is part of the __View__ layer. 
